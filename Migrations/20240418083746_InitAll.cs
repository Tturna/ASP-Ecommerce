        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BillingAddress = table.Column<string>(type: "TEXT", maxLength: 50, nullable: true),
                    MaintainerAddress = table.Column<string>(type: "TEXT", maxLength: 50, nullable: true),
                    ...
                    SaveBillingInfo = table.Column<bool>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TechDescription = table.Column<string>(type: "TEXT", maxLength: 500, nullable: true),
                    WarrantyDescription = table.Column<string>(type: "TEXT", maxLength: 500, nullable: true),
                    Price = table.Column<decimal>(type: "TEXT", nullable: false),
                    ImageUrl = table.Column<string>(type: "TEXT", maxLength: 200, nullable: false),
                    CategoryPath = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Products_AspNetUsers_MaintainerId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductReviewModel", x => x.Id);
                    table.ForeignKey(
